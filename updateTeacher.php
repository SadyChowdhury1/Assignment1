...
$id= $_POST['id'];
$query="UPDATE teacher SET department='$_POST[department]',name='$_POST[name]',nid='$_POST[nid]',address='$_POST[address]' where id='$_POST[id]'";
$run=mysqli_query($conn,$query);


if($run){
	echo "teacher data updated";
}
